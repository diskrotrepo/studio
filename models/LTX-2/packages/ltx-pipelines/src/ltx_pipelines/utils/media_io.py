...
def encode_audio_wav(audio: Audio, output_path: str) -> None:
    """Write an Audio object to a WAV file (PCM 16-bit, stereo)."""
    container = av.open(output_path, mode="w", format="wav")
